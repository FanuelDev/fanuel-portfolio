export default {
  ...
  spiritual: {
    ...
    teaching_title: 'Enseigner la gestion de ses avoirs comme enfant de Dieu',
    teaching_desc:  'Lors d\'un programme d\'enseignement organisé par T4J Church, j\'ai partagé sur la gestion de sa finance, de ses biens et de ses ressources en tant qu\'enfant de Dieu — une vision biblique de l\'intendance qui transforme concrètement la vie.',
